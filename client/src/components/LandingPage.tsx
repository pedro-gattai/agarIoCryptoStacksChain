...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="landing-page">
      ...
      {/* Interactive Roadmap */}
      <InteractiveRoadmap onShowWhitepaper={onShowWhitepaper} />
          ...
          <div className="footer-main">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://t.me/+wYTqPTvz7XY0MGVh" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="https://github.com/pedro-gattai/agarIoCryptoStacksChain" target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <div className="footer-links">
              ...
              <div className="footer-column">
                <h4>Community</h4>
                <a href="https://t.me/+wYTqPTvz7XY0MGVh" target="_blank" rel="noopener noreferrer">Telegram</a>
              </div>
              ...
              <div className="footer-column">
                ...
                <a href="https://github.com/pedro-gattai/agarIoCryptoStacksChain" target="_blank" rel="noopener noreferrer">GitHub</a>
              </div>
            </div>
          </div>
