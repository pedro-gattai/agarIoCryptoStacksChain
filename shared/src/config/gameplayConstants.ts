...
export const GAMEPLAY_CONSTANTS = {
  ...
  // Network settings
  NETWORK: {
    TICK_RATE: 5, // Server ticks per second (reduced from 10 to 5 for maximum stability)
    BROADCAST_RATE: 5, // Updates per second to clients (reduced from 10 to 5 for maximum stability)
  },
} as const;
